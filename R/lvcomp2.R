...
#'
#' The parameters include \code{r1, r2, a11, a12, a21, a22} with the usual
#' meanings. Here the a's are the per capita effects which determine K
#' (\code{a11 = 1/K}).
#'
#' @param t Times points that will return N.
#' @param n a vector of length two for the population sizes at time = t.
...
#' @seealso \code{\link{lvcomp3}}, \code{\link{lvcompg}},
#' \code{\link{clogistic}}
